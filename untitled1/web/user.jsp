...
<%@ page import="com.cszy.po.Articles" %>
...
<div class="div_03">
    <table border="1" cellspacing="0" align="center">
        ...
        %>
        <tr>
            <td><%=article.getId() != null ? article.getId() : "N/A"%></td>
            <td><%=article.getArticType()%></td>
            <td><%=article.getArticTitle()%></td>
            <td><%=article.getAuthor()%></td>
            <td><%=article.getPublishDate() != null ? article.getPublishDate() : "N/A"%></td>
        </tr>
        <%
            }
        %>
...
<script type="text/javascript">
    ...
    setInterval(function() {time2();}, 1000);
</script>
</body>
</html>